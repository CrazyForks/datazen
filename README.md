...
CI currently uses **Node.js 24**, **pnpm 11**, and **Rust stable**. See [CONTRIBUTING.md](CONTRIBUTING.md) and [CI & test matrix](docs/development/ci-test-matrix.md) for the full development and CI toolchain.
