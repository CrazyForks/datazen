...
//!
//! [`crate::ops_value_search`] has its own pair of constants
...
///
/// Inherited from [`crate::ops_workbench::MAX_SCAN_ROUNDS`], for the same
...
mod tests {
    ...
    fn tree_budget_hard_cap_is_the_key_tree_one_not_value_searchs() {
        ...
        assert_eq!(
            DEFAULT_TREE_BUDGET,
            crate::ops_value_search::DEFAULT_MAX_KEYS
        );
    }
