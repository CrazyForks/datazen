...
const ULTRA_DANGER = new Set([
  "FLUSHDB", "FLUSHALL", "SHUTDOWN", "DEBUG", "KEYS", "CONFIG",
  "ACL", "MODULE", "CLUSTER", "REPLICAOF", "SLAVEOF",
]);
...
export function dangerBadgeColor(level: DangerLevel): string {
  switch (level) {
    case "ultra-danger": return "bg-red-600 text-white";
    case "danger":       return "bg-orange-500 text-white";
    case "write":        return "bg-yellow-500 text-black";
