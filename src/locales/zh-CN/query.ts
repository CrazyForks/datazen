...
const pack = {
  ...
  'query.visualBuilder.title': '可视化查询构建器',
  'query.visualBuilder.tables': '表',
  'query.visualBuilder.searchTables': '搜索表…',
  'query.visualBuilder.columns': '列',
  'query.visualBuilder.searchColumns': '搜索列…',
  'query.visualBuilder.alias': '别名',
  'query.visualBuilder.aliasPlaceholder': 'AS…',
  'query.visualBuilder.aggregate': '聚合',
  'query.visualBuilder.noColumns': '请先选择表',
  'query.visualBuilder.where': '条件',
  'query.visualBuilder.addCondition': '添加条件',
  'query.visualBuilder.addGroup': '添加条件组',
  'query.visualBuilder.removeCondition': '移除条件',
  'query.visualBuilder.removeGroup': '移除条件组',
  'query.visualBuilder.table': '表',
  'query.visualBuilder.column': '列',
  'query.visualBuilder.operator': '运算符',
  'query.visualBuilder.value': '值',
  'query.visualBuilder.valuePlaceholder': '值',
  'query.visualBuilder.inPlaceholder': '逗号分隔的值',
  'query.visualBuilder.logicAnd': '并且',
  'query.visualBuilder.logicOr': '或者',
  'query.visualBuilder.sort': '排序',
  'query.visualBuilder.addSort': '添加排序',
  'query.visualBuilder.removeSort': '移除排序',
  'query.visualBuilder.asc': '升序',
  'query.visualBuilder.desc': '降序',
  'query.visualBuilder.groupBy': '分组',
  'query.visualBuilder.addGroupBy': '添加分组',
  'query.visualBuilder.removeGroupBy': '移除分组',
  'query.visualBuilder.distinct': '去重',
