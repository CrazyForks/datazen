...
const pack = {
  ...
  'query.visualBuilder.title': 'Visual Query Builder',
  'query.visualBuilder.tables': 'Tables',
  'query.visualBuilder.searchTables': 'Search tables…',
  'query.visualBuilder.columns': 'Columns',
  'query.visualBuilder.searchColumns': 'Search columns…',
  'query.visualBuilder.alias': 'Alias',
  'query.visualBuilder.aliasPlaceholder': 'AS…',
  'query.visualBuilder.aggregate': 'Aggregate',
  'query.visualBuilder.noColumns': 'Select a table first',
  'query.visualBuilder.where': 'Conditions',
  ...
  'query.visualBuilder.column': 'Column',
  'query.visualBuilder.operator': 'Operator',
  'query.visualBuilder.value': 'Value',
  'query.visualBuilder.valuePlaceholder': 'Value',
  'query.visualBuilder.inPlaceholder': 'Comma-separated values',
  'query.visualBuilder.logicAnd': 'AND',
  'query.visualBuilder.logicOr': 'OR',
  'query.visualBuilder.sort': 'Sort',
  'query.visualBuilder.addSort': 'Add Sort',
  'query.visualBuilder.removeSort': 'Remove sort',
  'query.visualBuilder.asc': 'ASC',
  'query.visualBuilder.desc': 'DESC',
  'query.visualBuilder.groupBy': 'Group By',
  'query.visualBuilder.addGroupBy': 'Add Group By',
  'query.visualBuilder.removeGroupBy': 'Remove group by',
