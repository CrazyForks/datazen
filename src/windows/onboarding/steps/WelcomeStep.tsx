      ...
      <div className="flex flex-col gap-3">
        ...
        <button
          ...
          className={cn(
            ...
            'bg-surface dark:bg-[linear-gradient(180deg,#121824,#0f131c)]',
        ...
        <button
          ...
          className="group flex items-center gap-4 rounded-xl border border-edge bg-surface dark:bg-[linear-gradient(180deg,#121824,#0f131c)] p-[18px_20px] text-left transition-all hover:border-edge-hi hover:bg-surface-raised dark:hover:bg-[#141a26] hover:-translate-y-px"
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-[11px] bg-accent/12 text-accent border border-accent/18">
